...
cookie = 'gr_user_id=369b158e-a04d-471e-a6af-91be2682116e; UM_distinctid=17c2a784b74f57-0041c7813c00c-a7d173c-1fa400-17c2a784b75490; _qddaz=QD.oeyvft.ibtdvl.ku3j0sao; Hm_lvt_f94e107103e3c39e0665d52b6d4a93e7=1632800099,1632817907,1632817924; laiyuan=7a08c112cda6a063.juming.com; PHPSESSID=87168vpmt4conc8m66s0a5fmpf; Juming_uid=301111; Juming_isapp=0; Juming_zhu=97b9dd7b70a7544f45f3a454e92cf663; Juming_jf=74eb278742fceb967fe5fa78b9221b37; Juming_qy=8751827c8ab12feb2bf1b09d7a066848'
            ...
            while True:
                ...
                if data['status'] == "落后":
                    ...
                    if sy_shijian <= int(d['shengyu_shijian']):
                        ...
                        shiji_price = int((now_price + add_price_num) - (now_price + add_price_num - daili_price) * 0.6)
                        if int(data['max_price']) >= shiji_price:
                            ...
                            jingjia_dict[self.key]['status'] = '超预算，停止'
...
class Bidding(QWidget):
    ...
    def initUI(self):
        ...
        self.remaining_time1 = QLineEdit(d['shengyu_shijian'])

        self.remaining_time2 = QLineEdit()
        self.remaining_time1.setPlaceholderText("仅可以输入整数")
        self.remaining_time2.setPlaceholderText("仅可以输入整数")
        ...
        self.grid.addWidget(self.remaining_time1, 2, 1)
        self.grid.addWidget(self.remaining_time2, 2, 2)
        ##########################################################################################
        ...
        # self.grid.addWidget(self.tableWidget, 2, 0, 2, 9)
        #
    ...
    #设置全局最高竞价金额
    def set_global_max_price(self):
        row_count = self.tableWidget.rowCount()
        for row in range(row_count):
            # 修改最大金额
            new_item = QTableWidgetItem(d['max_price'].strip())  # 添加最大金额
    ...
    def get_table_data(self):
        ...
        while True:
            ...
            for domain in all_domain:
                ...
                new_item.setTextAlignment(Qt.AlignCenter | Qt.AlignBottom)
                try:
                    if '超预算，停止' == self.tableWidget.item(data_row, 5).text():
                        status = '超预算，停止'
                except Exception:
                    pass
                # 添加数据 状态
                ...
                # 添加数据 预算
                try:
                    max_price = self.tableWidget.item(data_row, 6).text()
                except Exception:
                ...
                hour = date_time.hour
                minute = date_time.minute
                if hour*60+minute <= int(d['shengyu_shijian']) and status == '落后':
                    if self.thread_list == []:
