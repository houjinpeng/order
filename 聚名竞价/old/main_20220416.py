        ...
        while True:
            ...
            try:
                for key,value in jingjia_dict.items():
                    ...
                    if int(value['max_price']) < shiji_price+int(d['max_yijia']):
                        continue
    ...
    def run(self):
        ...
        while True:
            ...
            for domain in all_domain:
                ...
                try:
                    max_price = jingjia_dict[domain['ym']]['max_price']
                except Exception:
                ...
                try:
                    jingjia_dict[domain['ym']]['is_guding'] = domain['is_guding']
                except Exception as e:
                    pass
                if d['yincang'] == '2':
...
##############################################
        ...
        self.tableWidget.setHorizontalHeaderLabels(['id', '域名', '备注','领先价','实付价','外部/提成', '剩余时间', '结束时间', '状态', '预设价','出价额','操作','实际需付'])  # 设置行表头字段
    ...
    def init_table(self, parm):
        ...
        self.set_domain_table(data_row,[id, ym, remark, lx_price, shiji_price, ticheng, sytime, endtime, status, max_price,chujia,shifu_price ,guding])
    ...
    def set_domain_table(self,data_row,data_list):
        ...
        # new_item = QTableWidgetItem('<a href="https://blog.csdn.net/s_daqing">点击打开查看</a>')
        # new_item.setText('<a href="https://blog.csdn.net/s_daqing">点击打开查看</a>')
        # new_item.setTextInteractionFlags(Qt.TextBrowserInteraction)  # 双击可选中文本
        # self.tableWidget.setCellWidget(data_row, 11, self.set_link())
        ...
        new_item = QTableWidgetItem(max_price.strip())
